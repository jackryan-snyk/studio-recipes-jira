...
## Workflow
1. **Fetch:** Use the twg skill to read the Jira ticket. Get the ticket description. If the TWG Skill is not available then use the Atlassian MCP Server or Atlassian CLI to get the Jira ticket with description.
